...
// Challenge 1: Return only inventors born past the 1500s

const fifteen = inventors.filter(inventor => inventor.year >=1500 && inventor.year<=1600)

console.table(fifteen)

// Challenge 2: Return an array of the inventors' first and last names. 

const firstAndLast = inventors.map((inventor)=>console.table(`${inventor.first} ${inventor.last}`))

// Sort inventors by date, from oldest to youngest
